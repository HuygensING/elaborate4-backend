...
public class ElaborateEditorQueryComposerTest {
  ...
  public void testComposeQuery2() {
    ElaborateEditorSearchParameters sp =
        new ElaborateEditorSearchParameters() //
            .setProjectId(1);
    sp.setTerm("iets") //
  ...
  public void testComposeQuery4() {
    ...
    sp.setTerm("iets vaags") //
        .setFuzzy(true) //
        .setTextLayers(
            ImmutableList.of(TranscriptionType.DIPLOMATIC, TranscriptionType.COMMENTS)) //
        .setCaseSensitive(false) //
        .setSearchInAnnotations(true);
    String expected =
        "(title:(iets~0.75 vaags~0.75) textlayer_diplomatic:(iets~0.75 vaags~0.75) annotations_diplomatic:(iets~0.75 vaags~0.75) textlayer_comments:(iets~0.75 vaags~0.75) annotations_comments:(iets~0.75 vaags~0.75)) AND project_id:1";
    String expectedh =
