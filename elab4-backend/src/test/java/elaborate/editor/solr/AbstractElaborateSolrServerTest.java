...
public class AbstractElaborateSolrServerTest extends LoggableObject {

	@Test
	public void testExtractTerms() throws Exception {
		String snippet1 = "bladie <em>bla</em> <em>bla1</em>.";
		String snippet2 = "bladie <em>bla</em> <em>bla2</em>.";
		Collection<String> extractTerms = AbstractElaborateSolrServer.extractTerms(ImmutableList.of(snippet1, snippet2));
