...
public class MVNConverterTest {
  ...
  public void testRegelConversie() {
    ...
    //  Elke lb krijgt een n-attribuut dat het regelnummer per pagina aangeeft. Het wordt automatisch toegekend. Afwijkingen in de nummering worden aangegeven met de annotatie mvn:regelnummering (blad). Zie aldaar.
    ...
    //  Elke l krijgt een n-attribuut dat regelnummer per tekst aangeeft. Het wordt automatisch toegekend. Elke l krijgt een xml:id attribuut (concatenatie sigle, ’l’, n-attribuut)
    //
    //  Met lage prioriteit: Versregels die niet overeenkomen met fysieke regelafbreking worden aangegeven met mvn:versregel. Zie aldaar.
    //
  ...
  public void testAfkortingConversie() {
    ...
    //  </choice>
    //  De inhoud van de annotatie bevat gecursiveerde tekst. Deze gecursiveerde tekst overnemen binnen <ex>-elementen.
  }
  ...
  public void testInitiaalConversie() {
    //  mvn:initiaal
    //  Toelichting: De geannoteerde tekst is een initiaal. De hoogte van de initiaal wordt aangegeven in de annotatie (in aantal regels)
  ...
  public void testOphogingConversie() {
    ...
    //  Wanneer een ander element aanwezig is waarop het rend-attribuut kan worden aangebracht, is het <hi>- element niet noodzakelijk. 
    //
  }
  ...
  //  Het gaat hier alleen om markeringen, bijschriften en soortgelijke tekstjes, die ook in de publicatie in de marge geplaatst moeten worden. Deze annotatie wordt niet gebruikt voor toevoegingen aan de hoofdtekst. 
  //  Validatie: Geen
  ...
  //  Validatie: Als de waarde geen geheel getal is, moet de volgende regel, als die er is, ook een mvn:regelnummering (blad)-annotatie hebben. 
  //  Conversie: De annotatie overrulet het automatisch toegekende bladregelnummer. Het is ook de basis voor de bladregelnummers van de volgende regels.
  ...
  //  • de inhoud van de annotatie bestaat uit het tekstnummer: groepjes van tekens gescheiden door punten. De te gebruiken tekens zijn hoofdletters, kleine letters en cijfers (bijvoorbeeld: A.17.4b); in het geval van mvn:tekstbegin wordt het tekstnummer nog gevolgd door een puntkomma en dan een door de editeur aan de tekst toegekende titel.
  ...
  //  • Als een tekst met nummer 1.2.3 bestaat, moet er ook een tekst 1.2 bestaan, die 1.2.3 omvat. Tekst 1.2 bevat in dat geval geen ‘eigen’ tekst: alle erin bevatte tekst maakt deel uit van de deelteksten, met uitzondering van opschriften, onderschriften en teksten in de marge 
  ...
  //  • mvn:teksteind:</group>
  //
  //  De aan te maken text - en group-elementen krijgen een n-attribuut dat gelijk is aan het tekstnummer. Ze krijgen een xml:id attribuut dat bestaat uit sigle gevolgd door tekstnummer. 
  //
  ...
  public void testVreemdtekenConversie() {
    Annotation annotation = mockAnnotationOfType("mvn:vreemdteken");

  }

  //  mvn:versregel
  //  Toelichting: Geeft het beginpunt van een versregel wanneer dat niet samenvalt met het begin van de fysieke regel. Een puntannotatie.
  //  Validatie: Geen
  ...
  public void testVersregelConversie() {
    Annotation annotation = mockAnnotationOfType("mvn:versregel");
  }
  ...
  public void testWitregelConversie() {
    Annotation annotation = mockAnnotationOfType("mvn:witregel");

  }

  /* private methods */
  private Annotation mockAnnotationOfType(String value) {
    AnnotationType witregel = mockAnnotationType(value);
