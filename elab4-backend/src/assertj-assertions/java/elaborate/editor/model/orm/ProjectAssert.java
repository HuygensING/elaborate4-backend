...
public class ProjectAssert extends AbstractAssert<ProjectAssert, Project> {
  ...
  /**
   * An entry point for ProjectAssert to follow AssertJ standard <code>assertThat()</code>
   * statements.<br>
   * With a static import, one's can write directly : <code>assertThat(myProject)</code> and get
   ...
   *
   * @param annotationTypes the given elements that should be contained in actual Project's
   *     annotationTypes.
   * @return this assertion object.
   * @throws AssertionError if the actual Project's annotationTypes does not contain all given
   *     AnnotationType elements.
   */
  public ProjectAssert hasAnnotationTypes(AnnotationType... annotationTypes) {
    ...
    if (annotationTypes == null)
      throw new AssertionError("Expecting annotationTypes parameter not to be null.");
    ...
    // %s", "arg1").contains(annotationTypes);
   ...
   * @return this assertion object.
   * @throws AssertionError if the actual Project's facetFields does not contain all given String
   *     elements.
   */
  public ProjectAssert hasFacetFields(String... facetFields) {
    ...
    if (facetFields == null)
      throw new AssertionError("Expecting facetFields parameter not to be null.");
  ...
  public ProjectAssert hasNoFacetFields() {
    ...
    if (actual.getFacetFields().length > 0) {
      failWithMessage(
          assertjErrorMessage, actual, java.util.Arrays.toString(actual.getFacetFields()));
    }
   ...
   * @return this assertion object.
   * @throws AssertionError if the actual Project's facetInfo does not contain all given FacetInfo
   *     elements.
   */
  public ProjectAssert hasFacetInfo(FacetInfo... facetInfo) {
    ...
    if (facetInfo == null)
      throw new AssertionError("Expecting facetInfo parameter not to be null.");
   ...
   * @return this assertion object.
   * @throws AssertionError if the actual Project's logEntries does not contain all given LogEntry
   *     elements.
   */
  public ProjectAssert hasLogEntries(LogEntry... logEntries) {
    ...
    if (logEntries == null)
      throw new AssertionError("Expecting logEntries parameter not to be null.");
   ...
   *
   * @param projectEntries the given elements that should be contained in actual Project's
   *     projectEntries.
   * @return this assertion object.
   * @throws AssertionError if the actual Project's projectEntries does not contain all given
   *     ProjectEntry elements.
   */
  public ProjectAssert hasProjectEntries(ProjectEntry... projectEntries) {
    ...
    if (projectEntries == null)
      throw new AssertionError("Expecting projectEntries parameter not to be null.");
    ...
    // %s", "arg1").contains(projectEntries);
  ...
  /**
   * Verifies that the actual Project's projectEntryMetadataFieldnames contains the given String
   * elements.
   *
   * @param projectEntryMetadataFieldnames the given elements that should be contained in actual
   *     Project's projectEntryMetadataFieldnames.
   * @return this assertion object.
   * @throws AssertionError if the actual Project's projectEntryMetadataFieldnames does not contain
   *     all given String elements.
   */
  public ProjectAssert hasProjectEntryMetadataFieldnames(String... projectEntryMetadataFieldnames) {
    ...
    // check that given String varargs is not null.
    if (projectEntryMetadataFieldnames == null)
      throw new AssertionError(
          "Expecting projectEntryMetadataFieldnames parameter not to be null.");

    // check with standard error message (see commented below to set your own message).
    Assertions.assertThat(actual.getProjectEntryMetadataFieldnames())
        .contains(projectEntryMetadataFieldnames);
   ...
   *
   * @param projectLeaderId the given projectLeaderId to compare the actual Project's
   *     projectLeaderId to.
   * @return this assertion object.
  ...
  /**
   * Verifies that the actual Project's projectMetadataItems contains the given ProjectMetadataItem
   * elements.
   *
   * @param projectMetadataItems the given elements that should be contained in actual Project's
   *     projectMetadataItems.
   * @return this assertion object.
   * @throws AssertionError if the actual Project's projectMetadataItems does not contain all given
   *     ProjectMetadataItem elements.
   */
  public ProjectAssert hasProjectMetadataItems(ProjectMetadataItem... projectMetadataItems) {
    ...
    if (projectMetadataItems == null)
      throw new AssertionError("Expecting projectMetadataItems parameter not to be null.");
    ...
    // message %s", "arg1").contains(projectMetadataItems);
   ...
   * @return this assertion object.
   * @throws AssertionError if the actual Project's textLayers does not contain all given String
   *     elements.
   */
  public ProjectAssert hasTextLayers(String... textLayers) {
    ...
    // check that given String varargs is not null.
    if (textLayers == null)
      throw new AssertionError("Expecting textLayers parameter not to be null.");
  ...
  public ProjectAssert hasNoTextLayers() {
    ...
    if (actual.getTextLayers().length > 0) {
      failWithMessage(
          assertjErrorMessage, actual, java.util.Arrays.toString(actual.getTextLayers()));
    }
