...
public class TranscriptionAssert extends AbstractAssert<TranscriptionAssert, Transcription> {
  ...
  /**
   * Creates a new </code>{@link TranscriptionAssert}</code> to make assertions on actual
   * Transcription.
   *
  ...
  /**
   * An entry point for TranscriptionAssert to follow AssertJ standard <code>assertThat()</code>
   * statements.<br>
   * With a static import, one's can write directly : <code>assertThat(myTranscription)</code> and
   ...
   *
   * @param annotations the given elements that should be contained in actual Transcription's
   *     annotations.
   * @return this assertion object.
   * @throws AssertionError if the actual Transcription's annotations does not contain all given
   *     Annotation elements.
   */
  public TranscriptionAssert hasAnnotations(Annotation... annotations) {
    ...
    if (annotations == null)
      throw new AssertionError("Expecting annotations parameter not to be null.");
   ...
   * @return this assertion object.
   * @throws AssertionError - if the actual Transcription's modifiedOn is not equal to the given
   *     one.
   */
   ...
   *
   * @param projectEntry the given projectEntry to compare the actual Transcription's projectEntry
   *     to.
   * @return this assertion object.
   * @throws AssertionError - if the actual Transcription's projectEntry is not equal to the given
   *     one.
   */
   ...
   *
   * @param transcriptionType the given transcriptionType to compare the actual Transcription's
   *     transcriptionType to.
   * @return this assertion object.
   * @throws AssertionError - if the actual Transcription's transcriptionType is not equal to the
   *     given one.
   */
