...
public class FacsimileAssert extends AbstractAssert<FacsimileAssert, Facsimile> {
  ...
  /**
   * An entry point for FacsimileAssert to follow AssertJ standard <code>assertThat()</code>
   * statements.<br>
   * With a static import, one's can write directly : <code>assertThat(myFacsimile)</code> and get
