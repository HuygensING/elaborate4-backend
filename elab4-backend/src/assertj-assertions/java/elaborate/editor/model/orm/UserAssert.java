...
public class UserAssert extends AbstractAssert<UserAssert, User> {
  ...
  /**
   * An entry point for UserAssert to follow AssertJ standard <code>assertThat()</code> statements.
   * <br>
   * With a static import, one's can write directly : <code>assertThat(myUser)</code> and get
   ...
   *
   * @param encodedPassword the given elements that should be contained in actual User's
   *     encodedPassword.
   * @return this assertion object.
   * @throws AssertionError if the actual User's encodedPassword does not contain all given byte
   *     elements.
   */
  public UserAssert hasEncodedPassword(byte... encodedPassword) {
    ...
    if (encodedPassword == null)
      throw new AssertionError("Expecting encodedPassword parameter not to be null.");
    ...
    // %s", "arg1").contains(encodedPassword);
  ...
  public UserAssert hasNoEncodedPassword() {
    ...
    if (actual.getEncodedPassword().length > 0) {
      failWithMessage(
          assertjErrorMessage, actual, java.util.Arrays.toString(actual.getEncodedPassword()));
    }
   ...
   * @return this assertion object.
   * @throws AssertionError if the actual User's projects does not contain all given Project
   *     elements.
   */
   ...
   * @return this assertion object.
   * @throws AssertionError if the actual User's userSettings does not contain all given UserSetting
   *     elements.
   */
  public UserAssert hasUserSettings(UserSetting... userSettings) {
    ...
    if (userSettings == null)
      throw new AssertionError("Expecting userSettings parameter not to be null.");
