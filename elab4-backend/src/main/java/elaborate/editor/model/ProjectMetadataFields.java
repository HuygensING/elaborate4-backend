...
public class ProjectMetadataFields {
  ...
  public static final String PUBLISHABLE_PROJECT_ENTRY_METADATA_FIELDS =
      "publishableProjectEntryMetadataFields";
  public static final String FACETABLE_PROJECT_ENTRY_METADATA_FIELDS =
      "facetableProjectEntryMetadataFields";
  ...
  public static final String ANNOTATIONTYPE_STRIKE_DESCRIPTION =
      "annotationtype.strike.description";
