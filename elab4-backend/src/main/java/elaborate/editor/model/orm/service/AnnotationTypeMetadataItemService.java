...
@Singleton
public class AnnotationTypeMetadataItemService
    extends AbstractStoredEntityService<AnnotationTypeMetadataItem> {
  private static final AnnotationTypeMetadataItemService instance =
      new AnnotationTypeMetadataItemService();
