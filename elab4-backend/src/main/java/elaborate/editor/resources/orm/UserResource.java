...
public class UserResource extends AbstractElaborateResource {
  @Context private UserService userService;
  ...
  @Produces(UTF8MediaType.APPLICATION_JSON)
  @APIDesc(
      "Adds or sets a setting for the given field for the user with the given id, returns the new settings")
  public Object setUserSetting(
      @PathParam("id") long id, @PathParam("field") String field, String value) {
