...
public class TranscriptionWrapper {
  ...
  @JsonIgnore private Map<Integer, AnnotationData> annotationDataMap = null;
  ...
  // for output
  public TranscriptionWrapper(
      Transcription transcription, Map<Integer, AnnotationData> annotationDataMap) {
  ...
  @JsonIgnore public List<Integer> annotationNumbers = Lists.newArrayList();
  ...
  static String convertFromInput(String bodyIn) {
    ...
    return visitor
        .getContext()
        .getResult()
        .replace("<span class=\"hilite\" data-highlight=\"\"></span>", "")
        .trim();
  }
}
