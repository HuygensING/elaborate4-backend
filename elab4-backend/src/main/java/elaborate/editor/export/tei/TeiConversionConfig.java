...
public class TeiConversionConfig {
  ...
  private final Map<AnnotationType, Function<Annotation, TagInfo>> annotationTypeMapper =
      Maps.newHashMap();
  ...
  public TeiConversionConfig addAnnotationTypeMapping(
      AnnotationType type, Function<Annotation, TagInfo> mapping) {
