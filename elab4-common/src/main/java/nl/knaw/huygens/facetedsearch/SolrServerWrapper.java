...
public interface SolrServerWrapper {
   ...
   *
   * @return the boolean value <code>true</code> if everything is OK, <code>false</code> otherwise.
   */
  boolean ping();

  /**
   * Adds a document to the index, replacing a previously added document with the same unique id.
   *
